...
Конфигурационный файл -> https://github.com/llenar/HAProxy/blob/main/screen/haproxy-hw-2.cfg
```
global
	log /dev/log	local0
	log /dev/log	local1 notice
...
![alt text](https://github.com/llenar/HAProxy/blob/main/screen/srv%201%202%203.png)

![alt text](https://github.com/llenar/HAProxy/blob/main/screen/haproxy2.png)
